                      ...
                      <div key={idx} className="bg-slate-50/60 p-4 rounded-2xl border border-slate-100 flex flex-col gap-2 text-left">
                        ...
                        {sr.jukugo_1 && (
                          <div className="text-xs text-slate-700 font-medium grid grid-cols-1 sm:grid-cols-2 gap-1 bg-white/70 p-2 rounded-xl border border-slate-100">
                            ...
                            {sr.jukugo_2 && (
                              <div>
                                <strong className="text-slate-900 font-bold">Kata Kanji 2: </strong>
                                {sr.jukugo_2} {sr.jukugo_2_arti ? `(${sr.jukugo_2_arti})` : ""}
                              </div>
                            )}
                          </div>
                        )}
                    ...
                    <div className="space-y-4 mt-4 animate-scale-up">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-h-[300px] overflow-y-auto pr-1 sidebar-scroll">
                        {(() => {
                          ...
                          const parsedGroups = normalizeGroups(currQ.groups);
                          ...
                          const groupOptions = Array.from(
                            new Set(
                              parsedGroups.map((g: any) => g.name).filter(Boolean),
                            ),
                          );
