...
Kelompok ini berkaitan dengan kegiatan mengirimkan, meneruskan, atau menyebarkan pesan, informasi, data, dan sinyal kepada pihak lain. Seperti terdapat pada jukugo berikut ini:
送信（そうしん）mengirim pesan / mengirimkan (data/informasi)
Penjelasan:
...
電送（でんそう）pengiriman melalui media elektronik / transmisi elektronik
Penjelasan:
...
伝送（でんそう）meneruskan / mentransmisikan informasi, sinyal
Penjelasan:
伝：meneruskan, menyampaikan
送：mengirim, mentransmisikan
...
2) Pengiriman / Pengantarn Benda / Barang
Kelompok ini berkaitan dengan kegiatan mengirimkan, mengantarkan, memindahkan, atau mendistribusikan benda dan barang ke suatu tempat atau tujuan. Seperti terdapat pada jukugo berikut ini:
発送（はっそう）mengirim 
Penjelasan:
発：mengeluarkan, memulai, mengirim
送：mengirim, mengantarkan
...
直送（ちょくそう）pengiriman langsung ke tujuan
Penjelasan:
直：langsung
送：mengirim, mengantarkan
...
送付（そうふ）mengirimkan barang, dokumen, surat, dan sebagainya
Penjelasan:
送：mengirim, mengantarkan
付：menyerahkan, melampirkan
...
郵送（ゆうそう）mengirim melalui pos / surat
Penjelasan:
郵：pos
送：mengirim
...
配送（はいそう）pengiriman barang
Penjelasan:
配：membagikan, mendistribusikan
送：mengirim, mengantarkan
...
歓送（かんそう）melepas
 Penjelasan:
歓：senang, menyambut dengan gembira
送：mengantar, melepas
