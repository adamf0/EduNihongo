...
const kanjiInfo: Record<string, {
  ...
  "試": {
    ...
    onyomi: "シ",
    kunyomi: "ためす",
    baseMeaning: "Mencoba, menguji, melakukan percobaan untuk mengetahui kemampuan, kualitas atau pun hasil",
  ...
  "題": {
    ...
    jukugos: [
      { word: "問題", reading: "もんだい", meaning: "Soal/masalah", kanjiBreakdown: "問 : bertanya | 題 : topik atau persoalan", explanation: "Hubungan makna antar kanji 問 dan 題 ketika digabungkan menjadi 問題、menunjukan bahwa gabungan  kanji tersebut   mengandung makna suatu persoalan atau \"masalah yang harus diselesaikan\"." },
      { word: "課題", reading: "かだい", meaning: "Tugas", kanjiBreakdown: "課 : Pelajaran/mata kuliah | 題 : Topik", explanation: "Hubungan makna antara kanji 課 dan 題、ketika digabung menjadi 課題, menunjukan bahwa gabungan  kanji tersebut   mengandung makna  \"tugas yang diberikan untuk dikerjakan\"." },
      { word: "宿題", reading: "しゅくだい", meaning: "pekerjaan rumah", kanjiBreakdown: "宿 : tempat tinggal/rumah | 題 : tugas", explanation: "Hubungan makna antar kanji 宿 dan 題 apabila digabungkan menjadi 宿題、 menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"sesuatu tugas yang dikerjakan di rumah\"." },
      { word: "題名", reading: "だいめい", meaning: "judul", kanjiBreakdown: "題 : judul | 名 : nama", explanation: "Hubungan makna antar kanji 題dan 名, ketika digabungkan menjadi 題名、menunjukan bahwa gabungan  kanji tersebut   mengandung makna menunjukan makna atau arti nama sebuah tulisan atau karya." },
      { word: "表題", reading: "ひょうだい", meaning: "judul utama", kanjiBreakdown: "表 : bagian depan | 題 : judul", explanation: "Hubungan makna antar kanji 表 dan題, ketika digabungkan menjadi 表題、menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"judul yang muncul pada bagian dokumen\"." },
      { word: "主題", reading: "しゅだい", meaning: "tema utama", kanjiBreakdown: "主 : utama | 題 : tema", explanation: "Hubungan makna antar kanji 主 dan 題, ketika digabungkan menjadi kanji  主題、 menunjukan bahwa gabungan  kanji tersebut   mengandung makna  \"pokok pembahasan utama\"." },
      { word: "研究課題", reading: "けんきゅうかだい", meaning: "topik penelitian", kanjiBreakdown: "研究 : penelitian | 課題 : tugas", explanation: "Hubungan makna antar kanji 研究 dan課題, ketika digabungkan menjadi  研究課題、 menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"suatu masalah yang menjadi fokus penelitian\"." },
      { word: "論題", reading: "ろんだい", meaning: "tema kajian", kanjiBreakdown: "論 : argumen/diskusi | 題 : tema", explanation: "Hubungan makna antar kanji 論dan題, ketika digabungkan menjadi kanji論題、menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"topik yang dibahas secara akademik\"." },
      { word: "出題", reading: "しゅつだい", meaning: "pembuatan soal", kanjiBreakdown: "出 : mengeluarkan | 題 : soal", explanation: "Hubungan makna antar kanji 出dan題, ketika digabungkan menjadi kanji出題、menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"kegiatan membuat atau mengeluarkan soal\"." },
      { word: "話題", reading: "わだい", meaning: "topik pembicaraan", kanjiBreakdown: "話 : berbicara | 題 : topik", explanation: "Hubungan makna antar kanji 話 dan 題, menunjukan bahwa gabungan kedua kanji itu  mengandung makna\" sesuatu hal yang sedang dibicarakan\"." },
      { word: "時事問題", reading: "じじもんだい", meaning: "isu aktual", kanjiBreakdown: "時事 : peristiwa terkini | 問題 : masalah", explanation: "Hubungan makna antar kanji 時事 dan 問題 saat digabungkan 時事問題、menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"persoalan yang sedang hangat dibicarakan di ｍasyarakat\"." },
      { word: "問題意識", reading: "もんだいいしき", meaning: "kesadaran masalah", kanjiBreakdown: "問題 : masalah | 意識 : kesadaran", explanation: "Hubungan makna antar kanji 問題 dan 意識 saat digabungkan menjadi 問題意識、menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"suatu kemampuan adanya persoalan yang perlu diselesaikan\"." },
      { word: "題材", reading: "だいざい", meaning: "bahan cerita", kanjiBreakdown: "題 : tema | 材 : bahan", explanation: "Hubungan makna antar kanji 題 dan材, saat digabungakan menjadi kanji 題材、menunjukan bahwa gabungan  kanji tersebut   mengandung makna\"bahan atau tema yang digunakan untuk membuat sebuah karya\" (kotobank digital jiten)" },
      { word: "題字", reading: "だいじ", meaning: "tulisan judul", kanjiBreakdown: "題 : judul | 字 : huruf/lisan", explanation: "Hubungan makna antar kanji 題 dan字 ketika digabung menjadi 題字、menunjukan bahwa gabungan  kanji tersebut   mengandung makna \"tulisan yang digunakan sebagai judul\"." },
      { word: "演題", reading: "えんだい", meaning: "judul presentasi", kanjiBreakdown: "演 : presentasi / pertunjukan | 題 : judul", explanation: "Hubungan makna antar kanji dari kanji 演 dan題, ketika digabung menjadi 演題、menunjukan bahwa gabungan  kanji meengandung makna \"judul sebuah presentasi, seminar, atau pidato.\"" }
    ],
    examples: [
      {
  ...
  "点": {
    ...
    jukugos: [
      { word: "採点", reading: "さいてん", meaning: "penilaian", kanjiBreakdown: "採 : memberi/mengambil | 点 : nilai", explanation: "Hubungan makna antar kanji 採 dan 点, saat digabungkan menjadi 採点, menunjukan bahwa gabungan kedua kanji itu  mengandung makna “ kegiatan memberikan nilai terhadap hasil pekerjaan”" },
      { word: "得点", reading: "とくてん", meaning: "skor", kanjiBreakdown: "得 : memperoleh | 点 : poin", explanation: "Hubungan makna antar kanji 得 dan点 saat digabung menjadi 得点,  menunjukan bahwa gabungan kedua kanji itu  mengandung makna “jumlah nilai yang diperoleh seseorang”." },
      { word: "減点", reading: "げんてん", meaning: "pengurangan nilai", kanjiBreakdown: "減 : mengurangi | 点 : nilai", explanation: "Hubungan makna antar kanji減 dan 点 , mumjukan gabungan kanji  ini saat digabung menjadi 減点,  menunjukan bahwa gabungan kedua kanji itu  mengandung makna \"nilai yang dikurangi \"." },
      { word: "地点", reading: "ちてん", meaning: "lokasi", kanjiBreakdown: "地 : tempat | 点 : titik", explanation: "Hubungan makna antar kanji　地dan 点、menjadi 地点 , menunjukan bahwa gabungan kedua kanji itu  mengandung makna \"titik tertentu pada suatu lokasi\"" },
      { word: "起点", reading: "きてん", meaning: "titik awal", kanjiBreakdown: "起 : mulai | 点 : awal", explanation: "Hubungan makna antar kanji 起 dan 点 , menunjukan  bahwa gabungan  dua kanji  terserbut mengandung makna \"tempat dimulainya suatu perjalanan atau aktivitas\" ." },
      { word: "終点", reading: "しゅうてん", meaning: "titik akhir", kanjiBreakdown: "終 : selesai | 点 : tempat", explanation: "Hubungan makna antar kanji 終 dan 点 , menunjukan  bahwa gabungan  dua kanji  terserbut  mengandung makna  “tempat berakhirnya suatu perjalanan”." },
      { word: "観点", reading: "かんてん", meaning: "sudut pandang", kanjiBreakdown: "観 : melihat | 点 : titik", explanation: "Hubungan makna antar kanji 観 dan 点 menjadi 観点、menunjukan gabungaan dua kanji tersebut mengandung makna \"cara melihat/memandang  suatu persoalan \"" },
      { word: "視点", reading: "してん", meaning: "persepketif", kanjiBreakdown: "視 : melihat | 点 : titik", explanation: "Hubungan makna antar kanji 視 dan 点 menjadi 視点, menunjukan bahwa gabungan dua kanji tersebut mengandung makna \"posisi atau sudut pandang dalam memahami suatu masalah\"." },
      { word: "論点", reading: "ろんてん", meaning: "pokok bahasan", kanjiBreakdown: "論 : pembahasan | 点 : pokok", explanation: "Hubungan makna antar kanji 論 dan 点 menjadi 論点, menunjukan bahwa gabungan dua kanji tersebut mengandung makna \"masalah utama yang menjadi inti pembahasaan\"." },
      { word: "問題点", reading: "もんだいてん", meaning: "titik masalah", kanjiBreakdown: "問題 : masalah | 点 : titik", explanation: "Hubungan makna antar kanji 問題 dan 点 menjadi 問題点, menunjukan bahwa gabungan kedua  kanji tersebut mengandung makna \"bagian yang menjadi sumber masalah\"." },
      { word: "重点", reading: "じゅうてん", meaning: "fokus utama", kanjiBreakdown: "重 : penting | 点 : titik", explanation: "Hubungan makna antar kanji 重  dan 点 menjadi 重点, menunjukan bahwa gabungan kedua  kanji tersebut mengandung makna \"bagian yang terpenting untuk diperhatikan\"" },
      { word: "要点", reading: "ようてん", meaning: "poin penting", kanjiBreakdown: "要 : inti | 点 : poin", explanation: "Hubungan makna antar kanji 要  dan 点 menjadi 要点, menunjukan bahwa gabungan kedua  kanji tersebut mengandung makna \"poko dari suatu penjelasan\"." },
      { word: "点検", reading: "てんけん", meaning: "pemeriksaan", kanjiBreakdown: "点 : memeriksa | 検 : inspeksi", explanation: "Hubungan makna antar kanji   点 dan 検 menjadi 点検, menunjukan bahwa gabungan kedua  kanji tersebut mengandung makna \"keadaan memeriksa kondisi suatu benda atau sistem\"." },
      { word: "点灯", reading: "てんとう", meaning: "penerangan", kanjiBreakdown: "点 : menyalakan | 灯 : lampu", explanation: "Hubungan makna antar kanji点 dan 灯 menjadi 点灯、, menunjukan bahwa gabungan kedua  kanji tersebut mengandung makna \"menghidupkan lampu aatau penerangan\"." },
      { word: "点数", reading: "てんすう", meaning: "nilai", kanjiBreakdown: "点 : poin | 数 : jumlah", explanation: "Hubungan makna antar kanji点 dan数  menjadi　点数、 menunjukan bahwa gabungan kedua  kanji tersebut mengandung makna \"jumlah nilai yang diperoleh dalam suatu penilaian\"." }
    ],
    examples: [
      {
  ...
  "研": { romaji: "Ken", meaning: "Mengasah / Penelitian", bushuu: "石", onyomi: "ケン", kunyomi: "と（ぐ）", jukugos: [
  ...
  "究": { romaji: "Kyuu", meaning: "Menyelidiki Mendalam", bushuu: "穴", onyomi: "キュウ", kunyomi: "きわ（める）", jukugos: [
    { word: "研究", reading: "けんきゅう", meaning: "Penelitian" },
  ...
  "集": { romaji: "Shuu", meaning: "Mengumpulkan", bushuu: "隹", onyomi: "シュウ", kunyomi: "あつ（まる）、あつ（める）", jukugos: [
  ...
  "調": { romaji: "Chou", meaning: "Menyelidiki / Nada", bushuu: "言", onyomi: "チョウ", kunyomi: "しら（べる）、ととの（う）", jukugos: [
  ...
  "査": { romaji: "Sa", meaning: "Memeriksa", bushuu: "木", onyomi: "サ", kunyomi: "-", jukugos: [
    { word: "調査", reading: "ちょうさ", meaning: "Investigasi" },
  ...
  "実": { romaji: "Jitsu", meaning: "Kenyataan / Kebenaran", bushuu: "宀", onyomi: "ジツ", kunyomi: "み、みの（る）", jukugos: [
  ...
  "情": { romaji: "Jou", meaning: "Perasaan / Keadaan", bushuu: "心 (忄)", onyomi: "ジョウ", kunyomi: "なさ（け）", jukugos: [
  ...
  "報": { romaji: "Hou", meaning: "Laporan / Balasan", bushuu: "土", onyomi: "ホウ", kunyomi: "むく（いる）", jukugos: [
    { word: "情報", reading: "じょうほう", meaning: "Informasi" },
    { word: "報告", reading: "ほうこく", meaning: "Laporan" },
    { word: "報道", reading: "ほうどう", meaning: "Pemberitaan" },
    { word: "予報", reading: "よほう", meaning: "Prakiraan" }
  ]},
  "伝": { romaji: "Den", meaning: "Menyampaikan", bushuu: "人 (亻)", onyomi: "デン", kunyomi: "つた（わる）、つた（える）", jukugos: [
  ...
  "信": { romaji: "Shin", meaning: "Percaya", bushuu: "人 (亻)", onyomi: "シン", kunyomi: "しん（じる）", jukugos: [
  ...
  "受": { romaji: "Ju", meaning: "Menerima", bushuu: "又", onyomi: "ジュ", kunyomi: "う（ける）", jukugos: [
  ...
  "送": { romaji: "Sou", meaning: "Mengirim", bushuu: "辵 (⻌)", onyomi: "ソウ", kunyomi: "おく（る）", jukugos: [
  ...
  "職": { romaji: "Shoku", meaning: "Pekerjaan / Jabatan", bushuu: "耳", onyomi: "ショク", kunyomi: "-", jukugos: [
  ...
  "業": { romaji: "Gyou", meaning: "Usaha / Industri", bushuu: "木", onyomi: "ギョウ、ゴウ", kunyomi: "わざ", jukugos: [
    { word: "職業", reading: "しょくぎょう", meaning: "Profesi" },
    { word: "産業", reading: "さんぎょう", meaning: "Industri" },
    { word: "事業", reading: "じぎょう", meaning: "Bisnis / Proyek" },
    { word: "授業", reading: "じゅぎょう", meaning: "Pelajaran" }
  ]},
  "働": { romaji: "Dou", meaning: "Bekerja", bushuu: "人 (亻)", onyomi: "ドウ", kunyomi: "はたら（く）", jukugos: [
  ...
  "務": { romaji: "Mu", meaning: "Tugas / Kewajiban", bushuu: "力", onyomi: "ム", kunyomi: "つと（める）", jukugos: [
  ...
  "技": { romaji: "Gi", meaning: "Keahlian / Teknik", bushuu: "手 (扌)", onyomi: "ギ", kunyomi: "わざ", jukugos: [
  ...
  "術": { romaji: "Jutsu", meaning: "Seni / Cara", bushuu: "行", onyomi: "ジュツ", kunyomi: "すべ", jukugos: [
    { word: "技術", reading: "ぎじゅつ", meaning: "Teknologi" },
  ...
  "議": { romaji: "Gi", meaning: "Diskusi / Musyawarah", onyomi: "ギ", kunyomi: "-", jukugos: [
  ...
  "論": { romaji: "Ron", meaning: "Teori / Pendapat", onyomi: "ロン", kunyomi: "-", jukugos: [
    { word: "議論", reading: "ぎろん", meaning: "Diskusi" },
    { word: "論文", reading: "ろんぶん", meaning: "Tesis / Karya Ilmiah" },
    { word: "理論", reading: "りろん", meaning: "Teori" },
    { word: "論理", reading: "ろんり", meaning: "Logika" }
  ]},
  "談": { romaji: "Dan", meaning: "Pembicaraan", onyomi: "ダン", kunyomi: "-", jukugos: [
  ...
  "討": { romaji: "Tou", meaning: "Membahas", onyomi: "トウ", kunyomi: "う（つ）", jukugos: [
  ...
  "見": { romaji: "Ken", meaning: "Melihat", onyomi: "ケン", kunyomi: "み（る）、み（せる）", jukugos: [
  ...
  "意": { romaji: "I", meaning: "Maksud / Pikiran", onyomi: "イ", kunyomi: "-", jukugos: [
    { word: "意見", reading: "いけん", meaning: "Pendapat" },
  ...
  "経": { romaji: "Kei", meaning: "Melalui / Mengalami", onyomi: "ケイ、キョウ", kunyomi: "へ（る）", jukugos: [
  ...
  "昔": { romaji: "Mukashi", meaning: "Masa Lampau", onyomi: "セキ、シャク", kunyomi: "むかし", jukugos: [
  ...
  "歴": { romaji: "Reki", meaning: "Sejarah / Melewati", onyomi: "レキ", kunyomi: "-", jukugos: [
  ...
  "史": { romaji: "Shi", meaning: "Sejarah", onyomi: "シ", kunyomi: "-", jukugos: [
    { word: "歴史", reading: "れきし", meaning: "Sejarah" },
  ...
  "期": { romaji: "Ki", meaning: "Periode / Harapan", onyomi: "キ、ゴ", kunyomi: "-", jukugos: [
  ...
  "間": { romaji: "Kan", meaning: "Antara / Ruang / Waktu", onyomi: "カン、ケン", kunyomi: "あいだ、ま", jukugos: [
  ...
  "変": { romaji: "Hen", meaning: "Berubah / Aneh", onyomi: "ヘン", kunyomi: "か（わる）、か（える）", jukugos: [
  ...
  "化": { romaji: "Ka", meaning: "Berubah menjadi", onyomi: "カ、ケ", kunyomi: "ば（ける）", jukugos: [
    { word: "変化", reading: "へんか", meaning: "Perubahan" },
    { word: "文化", reading: "ぶんか", meaning: "Kebudayaan" },
    { word: "化学", reading: "かがく", meaning: "Kimia" },
    { word: "化粧", reading: "けしょう", meaning: "Make-up" }
  ]},
  "発": { romaji: "Hatsu", meaning: "Memancarkan / Memulai", onyomi: "ハツ、ホツ", kunyomi: "た（つ）", jukugos: [
  ...
  "展": { romaji: "Ten", meaning: "Berkembang", onyomi: "テン", kunyomi: "-", jukugos: [
  ...
  "進": { romaji: "Shin", meaning: "Maju / Melangkah", onyomi: "シン", kunyomi: "すす（む）", jukugos: [
  ...
  "成": { romaji: "Sei", meaning: "Menjadi / Tumbuh", onyomi: "セイ、ジョウ", kunyomi: "な（る）", jukugos: [
  ...
  "認": { romaji: "Nin", meaning: "Mengakui / Menyetujui", onyomi: "ニン", kunyomi: "みと（める）", jukugos: [
  ...
  "識": { romaji: "Shiki", meaning: "Pengetahuan / Membedakan", onyomi: "シキ", kunyomi: "-", jukugos: [
    { word: "認識", reading: "にんしき", meaning: "Persepsi" },
    { word: "知識", reading: "ちしき", meaning: "Pengetahuan" },
    { word: "意識", reading: "いしき", meaning: "Kesadaran" },
    { word: "常識", reading: "じょうしき", meaning: "Akal Sehat" }
  ]},
  "判": { romaji: "Han", meaning: "Menilai / Memutuskan", onyomi: "ハン", kunyomi: "わか（る）", jukugos: [
  ...
  "断": { romaji: "Dan", meaning: "Memutuskan / Menolak", onyomi: "ダン", kunyomi: "た（つ）、ことわ（る）", jukugos: [
    { word: "判断", reading: "はんだん", meaning: "Keputusan" },
  ...
  "考": { romaji: "Kou", meaning: "Berpikir", onyomi: "コウ", kunyomi: "かんが（える）", jukugos: [
  ...
  "想": { romaji: "Sou", meaning: "Membayangkan / Ide", onyomi: "ソウ、ソ", kunyomi: "-", jukugos: [
  ...
  "感": { romaji: "Kan", meaning: "Merasa / Perasaan", onyomi: "カン", kunyomi: "-", jukugos: [
    { word: "感情", reading: "かんじょう", meaning: "Emosi" },
    { word: "感謝", reading: "かんしゃ", meaning: "Terima Kasih" },
    { word: "感動", reading: "かんどう", meaning: "Terharu" },
    { word: "感想", reading: "かんそう", meaning: "Kesan" }
  ]},
  "覚": { romaji: "Kaku", meaning: "Mengingat / Sadar", onyomi: "カク", kunyomi: "おぼ（える）、さ（める）", jukugos: [
  ...
  "心": { romaji: "Shin", meaning: "Hati", onyomi: "シン", kunyomi: "こころ", jukugos: [
  ...
  "志": { romaji: "Shi", meaning: "Arah / Keinginan kuat", onyomi: "シ", kunyomi: "こころざし", jukugos: [
  ...
  "態": { romaji: "Tai", meaning: "Kondisi / Sikap", onyomi: "タイ", kunyomi: "-", jukugos: [
  ...
  "愛": { romaji: "Ai", meaning: "Cinta / Kasih Sayang", onyomi: "アイ", kunyomi: "いと（しい）", jukugos: [
  ...
  "係": { romaji: "Kei", meaning: "Hubungan / Petugas", onyomi: "ケイ", kunyomi: "かか（り）", jukugos: [
  ...
  "制": { romaji: "Sei", meaning: "Sistem / Aturan", onyomi: "セイ", kunyomi: "-", jukugos: [
  ...
  "関": { romaji: "Kan", meaning: "Hubungan / Gerbang", onyomi: "カン", kunyomi: "せき、かか（わる）", jukugos: [
    { word: "関係", reading: "かんけい", meaning: "Hubungan" },
    { word: "玄関", reading: "げんかん", meaning: "Pintu Masuk" },
    { word: "関心", reading: "かんしん", meaning: "Ketertarikan" },
    { word: "機関", reading: "きかん", meaning: "Lembaga" }
  ]},
  "団": { romaji: "Dan", meaning: "Kelompok / Organisasi", onyomi: "ダン", kunyomi: "-", jukugos: [
  ...
  "組": { romaji: "Kumi", meaning: "Kelompok / Menyusun", onyomi: "ソ", kunyomi: "く（む）、くみ", jukugos: [
  ...
  "協": { romaji: "Kyou", meaning: "Bekerja Sama", onyomi: "キョウ", kunyomi: "-", jukugos: [
  ...
  "理": { romaji: "Ri", meaning: "Alasan / Logika", onyomi: "リ", kunyomi: "ことわり", jukugos: [
  ...
  "解": { romaji: "Kai", meaning: "Memahami / Memecahkan", onyomi: "カイ、ゲ", kunyomi: "と（く）", jukugos: [
    { word: "理解", reading: "りかい", meaning: "Pemahaman" },
    { word: "解決", reading: "かいけつ", meaning: "Solusi" },
    { word: "解説", reading: "かいせつ", meaning: "Penjelasan" },
    { word: "解散", reading: "かいさん", meaning: "Pembubaran" }
  ]},
  "証": { romaji: "Shou", meaning: "Bukti / Kesaksian", onyomi: "ショウ", kunyomi: "あかし", jukugos: [
  ...
  "財": { romaji: "Zai", meaning: "Harta / Kekayaan", onyomi: "ザイ", kunyomi: "-", jukugos: [
  ...
  "済": { romaji: "Sai", meaning: "Selesai / Menoolong", onyomi: "サイ", kunyomi: "す（む）", jukugos: [
    { word: "経済", reading: "けいざい", meaning: "Ekonomi" },
  ...
  "費": { romaji: "Hi", meaning: "Biaya / Ongkos", onyomi: "ヒ", kunyomi: "つい（やす）", jukugos: [
  ...
  "消": { romaji: "Shou", meaning: "Padam / Menghapus", onyomi: "ショウ", kunyomi: "き（える）、け（す）", jukugos: [
    { word: "消費", reading: "しょうひ", meaning: "Konsumsi" },
  ...
  "供": { romaji: "Kyou", meaning: "Menyediakan / Pengikut", onyomi: "キョウ", kunyomi: "そな（える）、とも", jukugos: [
  ...
  "給": { romaji: "Kyuu", meaning: "Gaji / Menyediakan", onyomi: "キュウ", kunyomi: "たま（う）", jukugos: [
  ...
  for (let modIdx = 0; modIdx < 12; modIdx++) {
    ...
    for (const char of kanjiChars) {
      ...
      if (customGraphs[char]) {
        ...
        // Populate database MasterCategory and KategoriKanji relations
      ...
      await prisma.kanjiGraphEdge.createMany({
        data: graphEdges.map(ge => ({
          ...
          source: ge.source,
          target: ge.target,
          predicate: ge.predicate || ge.label || null,
        }))
      });
